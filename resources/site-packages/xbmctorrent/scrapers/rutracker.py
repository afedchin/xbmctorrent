...
BASE_URL = plugin.get_setting("base_rutracker") # "http://rutracker.org/forum/"
LOGIN_URL = BASE_URL + "login.php" # "http://rutracker.org/forum/login.php"
    ...
    with closing(SafeDialogProgress(delay_close=0)) as dialog:
        ...
        def _get_torrent_info(item):
            ...
            try:
                ...
                if True or not plugin.get_setting("rutracker_usesearch", bool):
        ...
        if "files" in metadata["info"]: # and ace_supported():
            ...
            for index, info in enumerate(metadata["info"]["files"]):
                ...
                if plugin.get_setting("torrent_engine", int) == 1 and ace_supported():
                    ...
                    path = plugin.url_for("play_file", uri=generate_magnet(metadata, item["label"]), index=index)
