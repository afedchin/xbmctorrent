...
from xbmctorrent import logpipe
...
def get_torrent2http_binary():
    ...
    if platform["os"] == "android":
        ...
        android_binary_dir = os.path.join(xbmc_data_path, "files", ADDON_ID, "bin", "%(os)s_%(arch)s" % PLATFORM)
...
def start(**kwargs):
    ...
    if PLATFORM["os"] == "windows":
        ...
        env = os.environ.copy()
        env["LD_LIBRARY_PATH"] = "%s:%s" % (torrent2http_dir, env.get("LD_LIBRARY_PATH", ""))
        kwargs["env"] = env
